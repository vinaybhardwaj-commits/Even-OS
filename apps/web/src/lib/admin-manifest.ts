...
export const adminRoutes: AdminRoute[] = [
  ...
  { path: '/admin/scm/purchase-requisitions', title: 'SCM Purchase Requisitions', pillar: 'ops', icon: '📑', blurb: 'PR workflow: KPMG tier-routed approval + convert to PO', roles: ADMIN_DEPT, shippedIn: 'P3.5', status: 'live', keywords: ['pr','requisition','prs','approval','tier'] },
  { path: '/admin/scm/grns',      title: 'SCM Goods Receipts', pillar: 'ops', icon: '📦', blurb: 'GRN with KPMG 10-item inspection + 3-way match against vendor invoice', roles: ADMIN_DEPT, shippedIn: 'P3.5', status: 'live', keywords: ['grn','receipt','3-way','3 way','inspection','kpmg'] },
  ...
  { path: '/admin/codes/charge-tiers', title: 'Codes — Charge Tiers', pillar: 'platform', icon: '💲', blurb: 'Unified price tiers + 21 Billing Manual rules + corporate empanelments', roles: ADMIN, shippedIn: 'C.4', status: 'live', keywords: ['charge tiers','prices','billing rules','empanelments','tariff','TPA'] },
