...
const ROLE_LABELS: Record<string, string> = {
  ...
  // Visiting Consultants (12 specialties)
  vc_general_medicine: 'VC — General Medicine',
  vc_general_surgery: 'VC — General Surgery',
  vc_orthopaedics: 'VC — Orthopaedics',
  vc_cardiology: 'VC — Cardiology',
  vc_neurology: 'VC — Neurology',
  vc_paediatrics: 'VC — Paediatrics',
  vc_obgyn: 'VC — OB/GYN',
  vc_anaesthesiology: 'VC — Anaesthesiology',
  vc_pulmonology: 'VC — Pulmonology',
  vc_nephrology: 'VC — Nephrology',
  vc_urology: 'VC — Urology',
  vc_ent: 'VC — ENT',
  visiting_consultant: 'Visiting Consultant',
  // Hospitalist / Consultants (12 specialties)
  consultant_general_medicine: 'Consultant — General Medicine',
  consultant_general_surgery: 'Consultant — General Surgery',
  consultant_orthopaedics: 'Consultant — Orthopaedics',
  consultant_cardiology: 'Consultant — Cardiology',
  consultant_neurology: 'Consultant — Neurology',
  consultant_paediatrics: 'Consultant — Paediatrics',
  consultant_obgyn: 'Consultant — OB/GYN',
  consultant_anaesthesiology: 'Consultant — Anaesthesiology',
  consultant_pulmonology: 'Consultant — Pulmonology',
  consultant_nephrology: 'Consultant — Nephrology',
  consultant_urology: 'Consultant — Urology',
  consultant_ent: 'Consultant — ENT',
  hospitalist: 'Hospitalist / Consultant',
  // Registrars (12 specialties)
  registrar_general_medicine: 'Registrar — General Medicine',
  registrar_general_surgery: 'Registrar — General Surgery',
  registrar_orthopaedics: 'Registrar — Orthopaedics',
  registrar_cardiology: 'Registrar — Cardiology',
  registrar_neurology: 'Registrar — Neurology',
  registrar_paediatrics: 'Registrar — Paediatrics',
  registrar_obgyn: 'Registrar — OB/GYN',
  registrar_anaesthesiology: 'Registrar — Anaesthesiology',
  registrar_pulmonology: 'Registrar — Pulmonology',
  registrar_nephrology: 'Registrar — Nephrology',
  registrar_urology: 'Registrar — Urology',
  registrar_ent: 'Registrar — ENT',
  resident: 'Registrar',
  // RMO
  rmo: 'RMO',
  // Legacy
  ...
  ot_nurse: 'OT Nurse',
  // Pharmacy, Lab, Radiology, Billing, Support
