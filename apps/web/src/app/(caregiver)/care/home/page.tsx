...
export default async function CaregiverHomePage() {
  ...
  const BUILT_ROUTES = ['/care/nurse', '/care/nurse/charge', '/care/nurse/bedside', '/care/nurse/emar', '/care/nurse/handoff', '/care/nurse/worksheet', '/care/doctor', '/care/pharmacy', '/care/lab', '/care/ot'];
